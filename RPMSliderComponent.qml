...
Item  {
    ...
    Rectangle {
        ...
        color: "#ffffff"
        width: parent.width / 100 * slider.rpmPercent  // Sets the width to the correct percent. This is a javascript expression, using the rpmPercent from above
        height: parent.height
    }
}
